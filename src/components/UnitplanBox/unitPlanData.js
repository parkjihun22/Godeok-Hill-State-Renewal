...
export const unitPlanData = {
  ...
  title: "힐스테이트 고덕엘리스트 타입안내",

  description:
    "힐스테이트 고덕엘리스트의 59㎡·84㎡ 타입별 평면을 확인할 수 있습니다. 타입별 공간 구성과 생활 동선을 비교하며 라이프스타일에 맞는 주거 공간을 살펴보세요.",
